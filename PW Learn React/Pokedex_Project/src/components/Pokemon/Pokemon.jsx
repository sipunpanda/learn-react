...
<div className="grid gap-y-8">
        ...
        <div class="h-98 w-72 mb-2.5 flex flex-col items-center justify-center max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          
                <img className="rounded-t-lg" src={image} alt="unavailable" />
            <div class="p-5">
                
                    <h5 class="mb-2 text-2xl font-bold tracking-wider underline decoration-2 text-gray-900 dark:text-white">{name}</h5>
